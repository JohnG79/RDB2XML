...
public class ForeignKeyNode extends AbstractLeafNode implements Foreign
{
    ...
    public ForeignKeyNode( int treeItemNumber, Object[] objects, String referencedRelationName, String referencedKeyName, String constraintName, Primary referencedPrimary, String dataType )
    {
