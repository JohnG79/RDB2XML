...
public class SchemaNode extends AbstractNonLeafNode implements SchemaObject {
    ...
    private HashMap<String, String> dataNamespaces = new HashMap<>();
    private HashMap<String, String> ontologyNamespaces = new HashMap<>();

    public void addDataNamespace(String prefix, String uri) {
        dataNamespaces.put(prefix, uri);
    }

    public void addOntologyNamespace(String prefix, String uri) {
        ontologyNamespaces.put(prefix, uri);
    }

    public HashMap<String, String> getDataNamespaces() {
        return dataNamespaces;
    }

    public HashMap<String, String> getOntologyNamespaces() {
